...
def real_time_speech_enhancer(noisy_speech):
    ...
    tflite_out = {
        ...
        'msfe6_en_ddb_cur_in': np.zeros((1, 1, 4, 32), dtype=np.float32),
        'msfe6_en_ddb_cur1': np.zeros((1, 1, 4, 16), dtype=np.float32),
        'msfe6_en_ddb_cur2': np.zeros((1, 2, 4, 32), dtype=np.float32),
        'msfe6_en_ddb_cur3': np.zeros((1, 4, 4, 48), dtype=np.float32),
        'msfe6_en_ddb_cur4': np.zeros((1, 8, 4, 64), dtype=np.float32),
        'msfe6_en_ddb_cur5': np.zeros((1, 16, 4, 80), dtype=np.float32),
        'msfe6_en_ddb_cur6': np.zeros((1, 32, 4, 96), dtype=np.float32),
        'msfe6_en_ddb_cur_out': np.zeros((1, 1, 4, 16), dtype=np.float32),
        # Encoder MSFE5 Dilated Dense Block
        'msfe5_en_ddb_cur_in': np.zeros((1, 1, 4, 32), dtype=np.float32),
        'msfe5_en_ddb_cur1': np.zeros((1, 1, 4, 16), dtype=np.float32),
        'msfe5_en_ddb_cur2': np.zeros((1, 2, 4, 32), dtype=np.float32),
        'msfe5_en_ddb_cur3': np.zeros((1, 4, 4, 48), dtype=np.float32),
        'msfe5_en_ddb_cur4': np.zeros((1, 8, 4, 64), dtype=np.float32),
        'msfe5_en_ddb_cur5': np.zeros((1, 16, 4, 80), dtype=np.float32),
        'msfe5_en_ddb_cur6': np.zeros((1, 32, 4, 96), dtype=np.float32),
        'msfe5_en_ddb_cur_out': np.zeros((1, 1, 4, 16), dtype=np.float32),
        # Encoder MSFE4 Dilated Dense Block
        'msfe4_en_ddb_cur_in': np.zeros((1, 1, 4, 32), dtype=np.float32),
        'msfe4_en_ddb_cur1': np.zeros((1, 1, 4, 16), dtype=np.float32),
        'msfe4_en_ddb_cur2': np.zeros((1, 2, 4, 32), dtype=np.float32),
        'msfe4_en_ddb_cur3': np.zeros((1, 4, 4, 48), dtype=np.float32),
        'msfe4_en_ddb_cur4': np.zeros((1, 8, 4, 64), dtype=np.float32),
        'msfe4_en_ddb_cur5': np.zeros((1, 16, 4, 80), dtype=np.float32),
        'msfe4_en_ddb_cur6': np.zeros((1, 32, 4, 96), dtype=np.float32),
        'msfe4_en_ddb_cur_out': np.zeros((1, 1, 4, 16), dtype=np.float32),
        # Encoder MSFE4 (2) Dilated Dense Block
        'msfe4_en2_ddb_cur_in': np.zeros((1, 1, 2, 32), dtype=np.float32),
        'msfe4_en2_ddb_cur1': np.zeros((1, 1, 2, 16), dtype=np.float32),
        'msfe4_en2_ddb_cur2': np.zeros((1, 2, 2, 32), dtype=np.float32),
        'msfe4_en2_ddb_cur3': np.zeros((1, 4, 2, 48), dtype=np.float32),
        'msfe4_en2_ddb_cur4': np.zeros((1, 8, 2, 64), dtype=np.float32),
        'msfe4_en2_ddb_cur5': np.zeros((1, 16, 2, 80), dtype=np.float32),
        'msfe4_en2_ddb_cur6': np.zeros((1, 32, 2, 96), dtype=np.float32),
        'msfe4_en2_ddb_cur_out': np.zeros((1, 1, 2, 16), dtype=np.float32),
        # Encoder MSFE4 (3) Dilated Dense Block
        'msfe4_en3_ddb_cur_in': np.zeros((1, 1, 1, 32), dtype=np.float32),
        'msfe4_en3_ddb_cur1': np.zeros((1, 1, 1, 16), dtype=np.float32),
        'msfe4_en3_ddb_cur2': np.zeros((1, 2, 1, 32), dtype=np.float32),
        'msfe4_en3_ddb_cur3': np.zeros((1, 4, 1, 48), dtype=np.float32),
        'msfe4_en3_ddb_cur4': np.zeros((1, 8, 1, 64), dtype=np.float32),
        'msfe4_en3_ddb_cur5': np.zeros((1, 16, 1, 80), dtype=np.float32),
        'msfe4_en3_ddb_cur6': np.zeros((1, 32, 1, 96), dtype=np.float32),
        'msfe4_en3_ddb_cur_out': np.zeros((1, 1, 1, 16), dtype=np.float32),
        # Encoder MSFE3 Dilated Dense Block
        'msfe3_en_ddb_cur_in': np.zeros((1, 1, 1, 32), dtype=np.float32),
        'msfe3_en_ddb_cur1': np.zeros((1, 1, 1, 16), dtype=np.float32),
        'msfe3_en_ddb_cur2': np.zeros((1, 2, 1, 32), dtype=np.float32),
        'msfe3_en_ddb_cur3': np.zeros((1, 4, 1, 48), dtype=np.float32),
        'msfe3_en_ddb_cur4': np.zeros((1, 8, 1, 64), dtype=np.float32),
        'msfe3_en_ddb_cur5': np.zeros((1, 16, 1, 80), dtype=np.float32),
        'msfe3_en_ddb_cur6': np.zeros((1, 32, 1, 96), dtype=np.float32),
        'msfe3_en_ddb_cur_out': np.zeros((1, 1, 1, 16), dtype=np.float32),
        # Dilated Dense Block
        'ddb_cur_in': np.zeros((1, 1, 4, 64), dtype=np.float32),
        'ddb_cur1': np.zeros((1, 1, 4, 32), dtype=np.float32),
        'ddb_cur2': np.zeros((1, 2, 4, 64), dtype=np.float32),
        'ddb_cur3': np.zeros((1, 4, 4, 96), dtype=np.float32),
        'ddb_cur4': np.zeros((1, 8, 4, 128), dtype=np.float32),
        'ddb_cur5': np.zeros((1, 16, 4, 160), dtype=np.float32),
        'ddb_cur6': np.zeros((1, 32, 4, 192), dtype=np.float32),
        'ddb_cur_out': np.zeros((1, 1, 4, 32), dtype=np.float32),
        # Decoder MSFE6 Dilated Dense Block
        'msfe6_de_ddb_cur_in': np.zeros((1, 1, 4, 32), dtype=np.float32),
        'msfe6_de_ddb_cur1': np.zeros((1, 1, 4, 16), dtype=np.float32),
        'msfe6_de_ddb_cur2': np.zeros((1, 2, 4, 32), dtype=np.float32),
        'msfe6_de_ddb_cur3': np.zeros((1, 4, 4, 48), dtype=np.float32),
        'msfe6_de_ddb_cur4': np.zeros((1, 8, 4, 64), dtype=np.float32),
        'msfe6_de_ddb_cur5': np.zeros((1, 16, 4, 80), dtype=np.float32),
        'msfe6_de_ddb_cur6': np.zeros((1, 32, 4, 96), dtype=np.float32),
        'msfe6_de_ddb_cur_out': np.zeros((1, 1, 4, 16), dtype=np.float32),
        # Decoder MSFE5 Dilated Dense Block
        'msfe5_de_ddb_cur_in': np.zeros((1, 1, 4, 32), dtype=np.float32),
        'msfe5_de_ddb_cur1': np.zeros((1, 1, 4, 16), dtype=np.float32),
        'msfe5_de_ddb_cur2': np.zeros((1, 2, 4, 32), dtype=np.float32),
        'msfe5_de_ddb_cur3': np.zeros((1, 4, 4, 48), dtype=np.float32),
        'msfe5_de_ddb_cur4': np.zeros((1, 8, 4, 64), dtype=np.float32),
        'msfe5_de_ddb_cur5': np.zeros((1, 16, 4, 80), dtype=np.float32),
        'msfe5_de_ddb_cur6': np.zeros((1, 32, 4, 96), dtype=np.float32),
        'msfe5_de_ddb_cur_out': np.zeros((1, 1, 4, 16), dtype=np.float32),
        # Decoder MSFE4 Dilated Dense Block
        'msfe4_de_ddb_cur_in': np.zeros((1, 1, 1, 32), dtype=np.float32),
        'msfe4_de_ddb_cur1': np.zeros((1, 1, 1, 16), dtype=np.float32),
        'msfe4_de_ddb_cur2': np.zeros((1, 2, 1, 32), dtype=np.float32),
        'msfe4_de_ddb_cur3': np.zeros((1, 4, 1, 48), dtype=np.float32),
        'msfe4_de_ddb_cur4': np.zeros((1, 8, 1, 64), dtype=np.float32),
        'msfe4_de_ddb_cur5': np.zeros((1, 16, 1, 80), dtype=np.float32),
        'msfe4_de_ddb_cur6': np.zeros((1, 32, 1, 96), dtype=np.float32),
        'msfe4_de_ddb_cur_out': np.zeros((1, 1, 1, 16), dtype=np.float32),
        # Decoder MSFE4 (2) Dilated Dense Block
        'msfe4_de2_ddb_cur_in': np.zeros((1, 1, 2, 32), dtype=np.float32),
        'msfe4_de2_ddb_cur1': np.zeros((1, 1, 2, 16), dtype=np.float32),
        'msfe4_de2_ddb_cur2': np.zeros((1, 2, 2, 32), dtype=np.float32),
        'msfe4_de2_ddb_cur3': np.zeros((1, 4, 2, 48), dtype=np.float32),
        'msfe4_de2_ddb_cur4': np.zeros((1, 8, 2, 64), dtype=np.float32),
        'msfe4_de2_ddb_cur5': np.zeros((1, 16, 2, 80), dtype=np.float32),
        'msfe4_de2_ddb_cur6': np.zeros((1, 32, 2, 96), dtype=np.float32),
        'msfe4_de2_ddb_cur_out': np.zeros((1, 1, 2, 16), dtype=np.float32),
        # Decoder MSFE4 (3) Dilated Dense Block
        'msfe4_de3_ddb_cur_in': np.zeros((1, 1, 4, 32), dtype=np.float32),
        'msfe4_de3_ddb_cur1': np.zeros((1, 1, 4, 16), dtype=np.float32),
        'msfe4_de3_ddb_cur2': np.zeros((1, 2, 4, 32), dtype=np.float32),
        'msfe4_de3_ddb_cur3': np.zeros((1, 4, 4, 48), dtype=np.float32),
        'msfe4_de3_ddb_cur4': np.zeros((1, 8, 4, 64), dtype=np.float32),
        'msfe4_de3_ddb_cur5': np.zeros((1, 16, 4, 80), dtype=np.float32),
        'msfe4_de3_ddb_cur6': np.zeros((1, 32, 4, 96), dtype=np.float32),
        'msfe4_de3_ddb_cur_out': np.zeros((1, 1, 4, 16), dtype=np.float32),
        # Decoder MSFE3 Dilated Dense Block
        'msfe3_de_ddb_cur_in': np.zeros((1, 1, 1, 32), dtype=np.float32),
        'msfe3_de_ddb_cur1': np.zeros((1, 1, 1, 16), dtype=np.float32),
        'msfe3_de_ddb_cur2': np.zeros((1, 2, 1, 32), dtype=np.float32),
        'msfe3_de_ddb_cur3': np.zeros((1, 4, 1, 48), dtype=np.float32),
        'msfe3_de_ddb_cur4': np.zeros((1, 8, 1, 64), dtype=np.float32),
        'msfe3_de_ddb_cur5': np.zeros((1, 16, 1, 80), dtype=np.float32),
        'msfe3_de_ddb_cur6': np.zeros((1, 32, 1, 96), dtype=np.float32),
        'msfe3_de_ddb_cur_out': np.zeros((1, 1, 1, 16), dtype=np.float32),
    ...
    for idx in range(num_blocks):
        ...
        tflite_out = nutls(input=sliced_mag,
                           ...
                           msfe6_en_ddb_prev_in=tflite_out['msfe6_en_ddb_cur_in'],
                           msfe6_en_ddb_prev1=tflite_out['msfe6_en_ddb_cur1'],
                           msfe6_en_ddb_prev2=tflite_out['msfe6_en_ddb_cur2'],
                           msfe6_en_ddb_prev3=tflite_out['msfe6_en_ddb_cur3'],
                           msfe6_en_ddb_prev4=tflite_out['msfe6_en_ddb_cur4'],
                           msfe6_en_ddb_prev5=tflite_out['msfe6_en_ddb_cur5'],
                           msfe6_en_ddb_prev6=tflite_out['msfe6_en_ddb_cur6'],
                           msfe6_en_ddb_prev_out=tflite_out['msfe6_en_ddb_cur_out'],
                           msfe5_en_ddb_prev_in=tflite_out['msfe5_en_ddb_cur_in'],
                           msfe5_en_ddb_prev1=tflite_out['msfe5_en_ddb_cur1'],
                           msfe5_en_ddb_prev2=tflite_out['msfe5_en_ddb_cur2'],
                           msfe5_en_ddb_prev3=tflite_out['msfe5_en_ddb_cur3'],
                           msfe5_en_ddb_prev4=tflite_out['msfe5_en_ddb_cur4'],
                           msfe5_en_ddb_prev5=tflite_out['msfe5_en_ddb_cur5'],
                           msfe5_en_ddb_prev6=tflite_out['msfe5_en_ddb_cur6'],
                           msfe5_en_ddb_prev_out=tflite_out['msfe5_en_ddb_cur_out'],
                           msfe4_en_ddb_prev_in=tflite_out['msfe4_en_ddb_cur_in'],
                           msfe4_en_ddb_prev1=tflite_out['msfe4_en_ddb_cur1'],
                           msfe4_en_ddb_prev2=tflite_out['msfe4_en_ddb_cur2'],
                           msfe4_en_ddb_prev3=tflite_out['msfe4_en_ddb_cur3'],
                           msfe4_en_ddb_prev4=tflite_out['msfe4_en_ddb_cur4'],
                           msfe4_en_ddb_prev5=tflite_out['msfe4_en_ddb_cur5'],
                           msfe4_en_ddb_prev6=tflite_out['msfe4_en_ddb_cur6'],
                           msfe4_en_ddb_prev_out=tflite_out['msfe4_en_ddb_cur_out'],
                           msfe4_en2_ddb_prev_in=tflite_out['msfe4_en2_ddb_cur_in'],
                           msfe4_en2_ddb_prev1=tflite_out['msfe4_en2_ddb_cur1'],
                           msfe4_en2_ddb_prev2=tflite_out['msfe4_en2_ddb_cur2'],
                           msfe4_en2_ddb_prev3=tflite_out['msfe4_en2_ddb_cur3'],
                           msfe4_en2_ddb_prev4=tflite_out['msfe4_en2_ddb_cur4'],
                           msfe4_en2_ddb_prev5=tflite_out['msfe4_en2_ddb_cur5'],
                           msfe4_en2_ddb_prev6=tflite_out['msfe4_en2_ddb_cur6'],
                           msfe4_en2_ddb_prev_out=tflite_out['msfe4_en2_ddb_cur_out'],
                           msfe4_en3_ddb_prev_in=tflite_out['msfe4_en3_ddb_cur_in'],
                           msfe4_en3_ddb_prev1=tflite_out['msfe4_en3_ddb_cur1'],
                           msfe4_en3_ddb_prev2=tflite_out['msfe4_en3_ddb_cur2'],
                           msfe4_en3_ddb_prev3=tflite_out['msfe4_en3_ddb_cur3'],
                           msfe4_en3_ddb_prev4=tflite_out['msfe4_en3_ddb_cur4'],
                           msfe4_en3_ddb_prev5=tflite_out['msfe4_en3_ddb_cur5'],
                           msfe4_en3_ddb_prev6=tflite_out['msfe4_en3_ddb_cur6'],
                           msfe4_en3_ddb_prev_out=tflite_out['msfe4_en3_ddb_cur_out'],
                           msfe3_en_ddb_prev_in=tflite_out['msfe3_en_ddb_cur_in'],
                           msfe3_en_ddb_prev1=tflite_out['msfe3_en_ddb_cur1'],
                           msfe3_en_ddb_prev2=tflite_out['msfe3_en_ddb_cur2'],
                           msfe3_en_ddb_prev3=tflite_out['msfe3_en_ddb_cur3'],
                           msfe3_en_ddb_prev4=tflite_out['msfe3_en_ddb_cur4'],
                           msfe3_en_ddb_prev5=tflite_out['msfe3_en_ddb_cur5'],
                           msfe3_en_ddb_prev6=tflite_out['msfe3_en_ddb_cur6'],
                           msfe3_en_ddb_prev_out=tflite_out['msfe3_en_ddb_cur_out'],
                           ddb_prev_in=tflite_out['ddb_cur_in'],
                           ddb_prev1=tflite_out['ddb_cur1'],
                           ddb_prev2=tflite_out['ddb_cur2'],
                           ddb_prev3=tflite_out['ddb_cur3'],
                           ddb_prev4=tflite_out['ddb_cur4'],
                           ddb_prev5=tflite_out['ddb_cur5'],
                           ddb_prev6=tflite_out['ddb_cur6'],
                           ddb_prev_out=tflite_out['ddb_cur_out'],
                           msfe6_de_ddb_prev_in=tflite_out['msfe6_de_ddb_cur_in'],
                           msfe6_de_ddb_prev1=tflite_out['msfe6_de_ddb_cur1'],
                           msfe6_de_ddb_prev2=tflite_out['msfe6_de_ddb_cur2'],
                           msfe6_de_ddb_prev3=tflite_out['msfe6_de_ddb_cur3'],
                           msfe6_de_ddb_prev4=tflite_out['msfe6_de_ddb_cur4'],
                           msfe6_de_ddb_prev5=tflite_out['msfe6_de_ddb_cur5'],
                           msfe6_de_ddb_prev6=tflite_out['msfe6_de_ddb_cur6'],
                           msfe6_de_ddb_prev_out=tflite_out['msfe6_de_ddb_cur_out'],
                           msfe5_de_ddb_prev_in=tflite_out['msfe5_de_ddb_cur_in'],
                           msfe5_de_ddb_prev1=tflite_out['msfe5_de_ddb_cur1'],
                           msfe5_de_ddb_prev2=tflite_out['msfe5_de_ddb_cur2'],
                           msfe5_de_ddb_prev3=tflite_out['msfe5_de_ddb_cur3'],
                           msfe5_de_ddb_prev4=tflite_out['msfe5_de_ddb_cur4'],
                           msfe5_de_ddb_prev5=tflite_out['msfe5_de_ddb_cur5'],
                           msfe5_de_ddb_prev6=tflite_out['msfe5_de_ddb_cur6'],
                           msfe5_de_ddb_prev_out=tflite_out['msfe5_de_ddb_cur_out'],
                           msfe4_de_ddb_prev_in=tflite_out['msfe4_de_ddb_cur_in'],
                           msfe4_de_ddb_prev1=tflite_out['msfe4_de_ddb_cur1'],
                           msfe4_de_ddb_prev2=tflite_out['msfe4_de_ddb_cur2'],
                           msfe4_de_ddb_prev3=tflite_out['msfe4_de_ddb_cur3'],
                           msfe4_de_ddb_prev4=tflite_out['msfe4_de_ddb_cur4'],
                           msfe4_de_ddb_prev5=tflite_out['msfe4_de_ddb_cur5'],
                           msfe4_de_ddb_prev6=tflite_out['msfe4_de_ddb_cur6'],
                           msfe4_de_ddb_prev_out=tflite_out['msfe4_de_ddb_cur_out'],
                           msfe4_de2_ddb_prev_in=tflite_out['msfe4_de2_ddb_cur_in'],
                           msfe4_de2_ddb_prev1=tflite_out['msfe4_de2_ddb_cur1'],
                           msfe4_de2_ddb_prev2=tflite_out['msfe4_de2_ddb_cur2'],
                           msfe4_de2_ddb_prev3=tflite_out['msfe4_de2_ddb_cur3'],
                           msfe4_de2_ddb_prev4=tflite_out['msfe4_de2_ddb_cur4'],
                           msfe4_de2_ddb_prev5=tflite_out['msfe4_de2_ddb_cur5'],
                           msfe4_de2_ddb_prev6=tflite_out['msfe4_de2_ddb_cur6'],
                           msfe4_de2_ddb_prev_out=tflite_out['msfe4_de2_ddb_cur_out'],
                           msfe4_de3_ddb_prev_in=tflite_out['msfe4_de3_ddb_cur_in'],
                           msfe4_de3_ddb_prev1=tflite_out['msfe4_de3_ddb_cur1'],
                           msfe4_de3_ddb_prev2=tflite_out['msfe4_de3_ddb_cur2'],
                           msfe4_de3_ddb_prev3=tflite_out['msfe4_de3_ddb_cur3'],
                           msfe4_de3_ddb_prev4=tflite_out['msfe4_de3_ddb_cur4'],
                           msfe4_de3_ddb_prev5=tflite_out['msfe4_de3_ddb_cur5'],
                           msfe4_de3_ddb_prev6=tflite_out['msfe4_de3_ddb_cur6'],
                           msfe4_de3_ddb_prev_out=tflite_out['msfe4_de3_ddb_cur_out'],
                           msfe3_de_ddb_prev_in=tflite_out['msfe3_de_ddb_cur_in'],
                           msfe3_de_ddb_prev1=tflite_out['msfe3_de_ddb_cur1'],
                           msfe3_de_ddb_prev2=tflite_out['msfe3_de_ddb_cur2'],
                           msfe3_de_ddb_prev3=tflite_out['msfe3_de_ddb_cur3'],
                           msfe3_de_ddb_prev4=tflite_out['msfe3_de_ddb_cur4'],
                           msfe3_de_ddb_prev5=tflite_out['msfe3_de_ddb_cur5'],
                           msfe3_de_ddb_prev6=tflite_out['msfe3_de_ddb_cur6'],
                           msfe3_de_ddb_prev_out=tflite_out['msfe3_de_ddb_cur_out'],
                           )
...
# load models
interpreter = tf.lite.Interpreter(model_path='./tflite/nutls.tflite')
interpreter.allocate_tensors()

# Get signature of tflite
signature = interpreter.get_signature_list()
print('Signature', signature)
nutls_lstm_sm = interpreter.get_signature_runner('nutls')
