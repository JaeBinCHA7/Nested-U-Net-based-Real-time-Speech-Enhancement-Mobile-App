...
public class RTSE_NUTLS_LSTM {
    ...
    public RTSE_NUTLS_LSTM(Activity activity, String tflitePath, int frame_len, int stride) throws IOException {
...
//        this.window = new double[this.frame_len];
        this.fft_bins = frame_len / 2 + 1;
        this.mags = new float[this.fft_bins];
        this.phase = new float[this.fft_bins];

//        for (int i = 0; i < this.frame_len; i++) {
//            this.window[i] = 0.5 * (1 - Math.cos(2 * Math.PI * i / (this.frame_len - 1)));
//        }
//        this.window[0] = 1e-7;
//        this.window[this.frame_len - 1] = 1e-7;

        // Tensorflow Hanning window
    ...
    // State for LSTM
    private float[][] msfe6_en_h = new float[1][21];
    private float[][] msfe6_en_c = new float[1][21];
    private float[][] msfe5_en_h = new float[1][21];
    private float[][] msfe5_en_c = new float[1][21];
    private float[][] msfe4_en_h = new float[1][21];
    private float[][] msfe4_en_c = new float[1][21];
    private float[][] msfe4_en2_h = new float[1][21];
    private float[][] msfe4_en2_c = new float[1][21];
    private float[][] msfe4_en3_h = new float[1][21];
    private float[][] msfe4_en3_c = new float[1][21];
    private float[][] msfe3_en_h = new float[1][21];
    private float[][] msfe3_en_c = new float[1][21];
    private float[][] state_c = new float[1][21];
    private float[][] state_h = new float[1][21];
    private float[][] msfe3_de_h = new float[1][21];
    private float[][] msfe3_de_c = new float[1][21];
    private float[][] msfe4_de_h = new float[1][21];
    private float[][] msfe4_de_c = new float[1][21];
    private float[][] msfe4_de2_h = new float[1][21];
    private float[][] msfe4_de2_c = new float[1][21];
    private float[][] msfe4_de3_h = new float[1][21];
    private float[][] msfe4_de3_c = new float[1][21];
    private float[][] msfe5_de_h = new float[1][21];
    private float[][] msfe5_de_c = new float[1][21];
    private float[][] msfe6_de_h = new float[1][21];
    private float[][] msfe6_de_c = new float[1][21];
    ...
    public float[][][][] runningTFLite(float[][][][] inputData) {
        ...
        inputs.put("state_h", state_h);
        inputs.put("state_c", state_c);
        ...
        outputs.put("state_h", state_h);
        outputs.put("state_c", state_c);
        ...
        tflite.runSignature(inputs, outputs, "nutls_lstm_sm");
    ...
    public double[] audioSE(double[] doubleData) {
        ...
        realTranformedBuffer = getComplexSlice(transformedBuffer, 0, 257); // Slicing Complex - Based on Index 256, Magnitude has a symmetrical, Phase +/- relationship.
        ...
        // TF-Masking
//        Complex[] outComplex = tfMasking(mags, phase, maskOneDim);
        Complex[] outComplex = spectralMapping(maskOneDim, phase);
        ...
        for (int i = 0; i < this.out_buffer.length; i++) {
            this.out_buffer[i] += windowed_samples[i];
        }
